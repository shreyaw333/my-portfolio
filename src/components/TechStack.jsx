  ...
  const techCategories = [
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "LangGraph", icon: "/langgraph.png" },
              ...
              {category.split ? (
                <div className="tech-split-section">
                  <div className="tech-sub-row">
                    <span className="tech-sub-label backend-label">Backend</span>
                    <div className="tech-items-horizontal">
                      {category.backend.map((tech, techIndex) => (
                        <div key={techIndex} className="tech-badge tech-badge-backend">
                  ...
                  <div className="tech-sub-row">
                    <span className="tech-sub-label frontend-label">Frontend</span>
                    <div className="tech-items-horizontal">
                      {category.frontend.map((tech, techIndex) => (
                        <div key={techIndex} className="tech-badge tech-badge-frontend">
                          <div className="tech-badge-icon">
                            <img src={tech.icon} alt={tech.name} />
                          </div>
                          <span className="tech-badge-name">{tech.name}</span>
